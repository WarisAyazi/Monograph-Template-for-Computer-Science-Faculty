...
% ---- Main body: Bahij Zar (12pt) ----
\setmainfont{Bahij Zar}

% ---- Titles: Bahij Titr ----
\newfontfamily\titlefont{Bahij Titr}

% ---- Tables: B Nazanin ----
\newfontfamily\tablefont{B Nazanin}

% =================================================
% Title → Heading 1 → Heading 2 (Size Hierarchy)
% =================================================

% Heading 1 (Section) – 14pt
\titleformat{\section}
{\titlefont\bfseries\fontsize{14}{16}\selectfont}
{\thesection}{1em}{}

% Heading 2 (Subsection) – 12pt
\titleformat{\subsection}
{\titlefont\bfseries\fontsize{12}{14}\selectfont}
{\thesubsection}{1em}{}

% Heading 3 (Optional) – 11pt
\titleformat{\subsubsection}
{\titlefont\bfseries\fontsize{10}{12}\selectfont}
{\thesubsubsection}{1em}{}

% =================================================
% Table Caption (Title) – 12pt, NOT bold
% =================================================
\DeclareCaptionFont{tablecap}{\tablefont\fontsize{10}{12}\selectfont}
\captionsetup[table]{font=tablecap, labelfont=normalfont}

% =================================================
% Table Content – 10pt
% =================================================
\newcommand{\tablecontent}{\tablefont\fontsize{8}{10}\selectfont}


\usepackage{fancyhdr}
\usepackage{titlesec} % optional but recommended
...
\hypersetup{
	...
	linkcolor=black,    % Color for internal links (TOC, refs)
